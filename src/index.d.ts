...
export type ParametricSelector<S, P extends any[], R> = (
  state: S,
  ...args: P
) => R;

export type ParametricResolver<S, P extends any[]> = (
  state: S,
  ...args: P
) => any;
...
export type OutputParametricCachedSelector<S, P extends any[], R, C> = (
  ...
  removeMatchingSelector: (state: S, ...args: P) => void;
  clearCache: () => void;
  resultFunc: C;
  cache: ICacheObject;
};
...
/* one selector */
export default function createCachedSelector<S, P extends any[], R1, T>(
  selector: ParametricSelector<S, P, R1>,
  combiner: (res: R1) => T
): OutputParametricCachedSelector<S, P, T, (res: R1) => T>;

/* two selectors */
export default function createCachedSelector<S, P extends any[], R1, R2, T>(
...
/* three selectors */
export default function createCachedSelector<S, P extends any[], R1, R2, R3, T>(
  selector1: ParametricSelector<S, P, R1>,
  selector2: ParametricSelector<S, P, R2>,
...
>(
  ...
  combiner: (...args: R) => T
): OutputParametricCachedSelector<S, P, T, (...args: R) => T>;
